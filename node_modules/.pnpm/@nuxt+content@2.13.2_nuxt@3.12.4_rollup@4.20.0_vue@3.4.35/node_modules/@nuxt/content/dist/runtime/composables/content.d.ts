...
export declare const useContentState: <G extends object = Record<string, unknown>>() => {
    pages: import("vue").Ref<Record<string, ParsedContent>>;
    surrounds: import("vue").Ref<Record<string, [Omit<ParsedContent, "body"> | null, Omit<ParsedContent, "body"> | null]>>;
    navigation: import("vue").Ref<NavItem[]>;
    globals: import("vue").Ref<Record<string, G>>;
};
