import fs from 'fs';
import { defineNuxtModule, createResolver, extendViteConfig, addImports, addComponentsDir, addTemplate, addServerPlugin, addPlugin, installModule, addVitePlugin } from '@nuxt/kit';
