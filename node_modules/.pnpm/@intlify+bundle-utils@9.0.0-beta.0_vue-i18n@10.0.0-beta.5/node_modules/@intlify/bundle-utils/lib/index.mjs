...
function generate$2(targetSource, {
  ...
  const codeMaps = _generate$2(generator, ast, options);
...
export { checkInstallPackage, generate$2 as generateJSON, generate as generateJavaScript, generate$1 as generateYAML, getVueI18nVersion };
