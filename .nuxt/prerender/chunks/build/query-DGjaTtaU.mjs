import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///Users/christoph/Desktop/try-out%202/node_modules/.pnpm/vue@3.4.35_typescript@5.5.4/node_modules/vue/index.mjs';
import { W as useNuxtApp, X as asyncDataDefaults, Y as createError, R as useRuntimeConfig, a0 as withLeadingSlash, N as joinURL, P as withoutTrailingSlash, Z as withBase, $ as useRequestEvent, U as hash } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-u9EKDS_a.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DGjaTtaU.mjs.map
