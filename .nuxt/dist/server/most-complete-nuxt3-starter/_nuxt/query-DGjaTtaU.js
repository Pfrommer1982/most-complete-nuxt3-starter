...
import { W as useNuxtApp, X as asyncDataDefaults, Y as createError, Z as withBase, R as useRuntimeConfig, $ as useRequestEvent, a0 as withLeadingSlash, N as joinURL, P as withoutTrailingSlash, U as hash } from "../../server.mjs";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-u9EKDS_a.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DGjaTtaU.js.map
